...
declare const CLAMP_PARAMETERS: Array<[number /**min */, number /**max */]>;
...
export { AbstractScheduler, CLAMP_PARAMETERS, type Card, type CardInput, DECAY, type DateInput, DefaultInitSeedStrategy, FACTOR, FSRS, FSRSAlgorithm, type FSRSHistory, type FSRSParameters, type FSRSReview, type FSRSState, FSRSVersion, GenSeedStrategyWithCardId, type Grade, Grades, INIT_S_MAX, type IPreview, type IReschedule, type IScheduler, Rating, type RatingType, type RecordLog, type RecordLogItem, type RescheduleOptions, type ReviewLog, type ReviewLogInput, S_MIN, State, type StateType, StrategyMode, type TSchedulerStrategy, type TSeedStrategy, type TStrategyHandler, TypeConvert, clamp, createEmptyCard, dateDiffInDays, date_diff, date_scheduler, default_enable_fuzz, default_enable_short_term, default_maximum_interval, default_request_retention, default_w, type double, fixDate, fixRating, fixState, forgetting_curve, formatDate, fsrs, generatorParameters, get_fuzz_range, type int, show_diff_message, type unit };
